...
VkRenderPassBeginInfo vkinit::renderpass_begin_info(VkRenderPass renderPass, VkExtent2D windowExtent2D, VkFramebuffer frameBuffer, const std::vector<VkClearValue>& clearValues) {
    ...
    rpInfo.renderArea.extent = windowExtent2D;
